...
for i in listdir('/home/pranab/Desktop/fake/new_images/'):
	...
	# cv2.imwrite(path+'front-7_'+sampleNum+'.png',govSignature)
	...
	# cv2.imwrite(path+'front-10_'+sampleNum+'.png',rupeeSymbol)
	# cv2.imwrite(path+'front-11_'+sampleNum+'.png',ashoka)
	cv2.imwrite(path+'front-12_'+str(sampleNum)+'.png',horizontalRec)
	# cv2.imwrite(path+'front-13_'+sampleNum+'.png',leftLines)
	# cv2.imwrite(path+'front-14_'+sampleNum+'.png',rightLines)
